...
public class ProductSepatuFormal extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_product_sepatu_formal);
    ...
    public void product1(View view){
        Intent i = new Intent(ProductSepatuFormal.this, Home.class);
        startActivity(i);
    }
    ...
    public void keranjang(View view){
        Intent i = new Intent(ProductSepatuFormal.this, Keranjang.class);
        startActivity(i);
    }

    public void kembali(View view){
        Intent i = new Intent(ProductSepatuFormal.this, FashionPria.class);
        startActivity(i);
    }
}