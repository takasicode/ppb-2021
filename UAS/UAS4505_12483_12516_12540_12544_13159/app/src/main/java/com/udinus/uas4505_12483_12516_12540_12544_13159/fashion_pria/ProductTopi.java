...
public class ProductTopi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_product_topi);
    ...
    public void product1(View view){
        Intent i = new Intent(ProductTopi.this, Home.class);
        startActivity(i);
    }
    ...
    public void keranjang(View view){
        Intent i = new Intent(ProductTopi.this, Keranjang.class);
        startActivity(i);
    }

    public void kembali(View view){
        Intent i = new Intent(ProductTopi.this, FashionPria.class);
        startActivity(i);
    }
}