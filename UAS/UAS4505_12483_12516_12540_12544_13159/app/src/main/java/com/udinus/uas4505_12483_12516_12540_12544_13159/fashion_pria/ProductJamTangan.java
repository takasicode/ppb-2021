...
public class ProductJamTangan extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_product_jam_tangan
        );
    ...
    public void product1(View view){
        Intent i = new Intent(ProductJamTangan.this, Home.class);
        startActivity(i);
    }
    ...
    public void keranjang(View view){
        Intent i = new Intent(ProductJamTangan.this, Keranjang.class);
        startActivity(i);
    }

    public void kembali(View view){
        Intent i = new Intent(ProductJamTangan.this, FashionPria.class);
        startActivity(i);
    }
}