...
public class WelcomeBackActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "fadhil";
    private static final String DUMMY_PASSWORD = "12544";
    ...
    private void loadSavedUsername()
    {
        ...
        String savedUsername =
                this.sharedPrefs.getString(USERNAME_KEY, null);
